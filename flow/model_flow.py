        ...
        with tf.variable_scope(self.name, reuse = reuse) as vs:
            ...
            for l, (features_0, features_1) in enumerate(zip(pyramid_0, pyramid_1)):
                ...
                if l == 0:
                    ...
                    _, h, w, _ = tf.unstack(tf.shape(features_0))
                    flows_up = flows_up[:,:h,:w,:]
                    features_up = features_up[:,:h,:w,:]
                ...
                if l < self.output_level:
                    ...
                    _, hf, wf, _ = tf.unstack(tf.shape(images_0))
                    flows_final = tf.image.resize_bilinear(flows, (h*upscale, w*upscale))[:,:hf,:wf,:]*20.
